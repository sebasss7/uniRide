...
import { AlarmClock, Calendar1, MapPinHouse, MapPinSearch } from 'lucide-react-native';
...
export default function homeScreen() {
    ...
    const viajesFiltrados = useMemo(() => {
        if (!filtrosAplicados) return viajes.filter((v) => v.estado_viaje === 'disponible');
        ...
        return viajes.filter((v) => {
            ...
            return matchOrigen && matchDestino && matchFecha && matchHora && v.estado_viaje === 'disponible';
        });
    }, [viajes, filtrosAplicados, filtrOrigen, filtroDestino, filtroFecha, filtroHora]);
