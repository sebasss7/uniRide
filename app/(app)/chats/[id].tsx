    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.noEncontrado}>
          <Text style={styles.noEncontradoTexto}>Chat no encontrado</Text>
      ...
      <SafeAreaView style={styles.inner}>
        <View style={styles.header}>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel={`Ver perfil de ${otroUsuario.nombre}`}
            accessibilityRole="button"
          >
        ...
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity
            style={[styles.sendButton, !mensajeText.trim() && { opacity: 0.5 }]}
            onPress={handleEnviarMensaje}
            disabled={!mensajeText.trim()}
